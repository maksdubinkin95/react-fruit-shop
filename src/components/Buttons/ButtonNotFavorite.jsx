...
const ButtonNotFavorite = ({ disabled, title, img, price, description, setIsLiked, isLiked, addToFavorites }) => {
    return (
        <button disabled={disabled} className="card__button button-like" onClick={() => setIsLiked(!isLiked)}>
            <div className="button-like--noactive" onClick={() => addToFavorites({ title, img, price, description })}>
...
export default ButtonNotFavorite;
